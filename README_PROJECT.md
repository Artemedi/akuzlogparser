# akuzlogparser — AKUZ Log Explorer v4.2.1
...
При переносе исправлений на Windows **не удаляйте** и **не заменяйте**
ConnectConf.cfg, reports/, cache/, downloads/ или data/. Обновите исходники
и статические файлы из новой поставки и откройте /errors.html через
START_EXPLORER.bat — SQLite индекс и статический снимок аналитики
перестроятся локально из существующих отчётов. На странице можно отдельно
подтвердить дату первой записи уже обработанных журналов. См. README_ANALYTICS.md.
